		...
		<div class="flex-container">
			...
			<form:form action="${addAction}" commandName="product"
					...
					<c:choose>
						<c:when test="${!empty product.id}">
							...
							<div class="form-group">
								...
								<div class="controls docs-input-sizes">
									<form:input placeholder="id" path="id" required="true" class="form-control" id="id" disabled="true" readonly="true" />
								</div>
							</div>
						...
						<c:otherwise>
							...
							<div class="form-group">
								...
								<div class="controls docs-input-sizes">
									<form:input placeholder="id" path="id" required="true" class="form-control" id="id"
				...
				<div class="form-group">
					...
					<div class="controls docs-input-sizes">
						<form:input placeholder="name" path="name" required="true" class="form-control" id="name" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="controls docs-input-sizes">
						<form:input placeholder="description" path="description" class="form-control" id="description" />
					</div>
				</div>
					...
					<table class="tg">
						...
						<c:forEach items="${productList}" var="product">
							<tr>
								...
								<td><img
									src="<c:url value="/resources/images/productImages/${product.id}.png"/>" height="142" width="142" alt="product image" /></td>
								<td><a
									href="<c:url value="/resources/images/productImages/${product.id}.png"/>">Clickhere</a></td>
							</tr>
						</c:forEach>
					</table>
				</c:if>
