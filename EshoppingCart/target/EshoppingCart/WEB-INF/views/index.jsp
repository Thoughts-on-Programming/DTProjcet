 ...
 <a href="<c:url value="/j_spring_security_logout"/>">logout</a> 
	   	 ...
	   	 <nav id="main-nav-wrap">
				...
				<ul class="main-navigation">
					...
					<li><a class="smoothscroll"  href="#AboutUs" title="">AboutUs</a></li>
					<li><a class="smoothscroll"  href="#ContactUs" title="">ContactUs</a></li>
					<li><a class="smoothscroll"  href="#pricing" title="">Pricing</a></li>
					<li><a class="smoothscroll"  href="#faq" title="">FAQ</a></li>					
					 <li class="highlight with-sep"><a href="<c:url value="/register"/>" title="">Sign Up</a></li>	
									<li class="highlight with-sep"><a href="loginpage" title="">Sign In</a></li>	
...
<!-- 
 ...
 -->
	   			...
	   			<!-- <div class='video-link'>
	   				<a href="#video-popup"><img src="/EshoppingCart/resources/images/play-button.png" alt=""></a>
	   			</div> -->
